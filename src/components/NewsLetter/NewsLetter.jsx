...
const NewsLetter = () => {
    return (
        ...
        w-full max-w-7xl mx-auto min-h-[365px] sm:min-h-[300px] md:min-h-[365px] bg-cover bg-center bg-no-repeat px-4 sm:px-6 md:px-8 lg:px-12 py-10 rounded-xl mb-12'>
